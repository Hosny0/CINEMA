 ...
 *
 *	<input class=" info" name="partnumber">
 *	<input class=" info" name="description">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,". info"]},
 * description: {require_from_group: [1,". info"]}
 *
 ...
 *	<input class=" info" name="partnumber">
 *	<input class=" info" name="description">
 *	<input class=" info" name="color">
 *
 *	...will validate unless either at least two of them are filled,
 *	OR none of them are.
 *
 * partnumber:	{skip_or_fill_minimum: [2,". info"]},
 * description: {skip_or_fill_minimum: [2,". info"]},
 * color:		{skip_or_fill_minimum: [2,". info"]}
 *
 * options[0]: number of fields that must be filled in the group
 * options[1]: CSS selector that defines the group of conditionally required fields
 *
